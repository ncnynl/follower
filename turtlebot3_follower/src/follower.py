    ...
    def follow(self):
        while not rospy.is_shutdown():
            ...
            if  check == 1:
                ...
                if  x == ['30_0']:
                    twist.linear.x  = -0.23;      	twist.angular.z = 0.0;
                elif x== ['30_l']:
                    twist.linear.x  = -0.20; 		twist.angular.z = 0.8;
                elif x== ['30_r']:
                    twist.linear.x  = -0.20; 		twist.angular.z = -0.8;
                elif x== ['45_0']:
                    twist.linear.x  = -0.23;      	twist.angular.z = 0.0;
                elif x== ['45_l']:
                    twist.linear.x  = -0.20; 		twist.angular.z = 0.6;
                elif x== ['45_r']:
                    twist.linear.x  = -0.20; 		twist.angular.z = -0.6;
                elif x== ['15_0']:
                ...
                if x== ['empty']:
                    ...
                    twist.linear.x  = 0.0; 		twist.angular.z = 0.8;
